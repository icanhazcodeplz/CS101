...
public class lab11Arrays {
    public static void main(String[] args) {
        ...
        // 16. Create an int array called `squares` with a length of 5 (don't fill in values yet)
        //     Hint: int[] squares = new int[5];
        ...
        // 18. Print the array using: System.out.println(Arrays.toString(squares))
        ...
        //     Hint: reversed[i] = numbers[numbers.length - 1 - i]
