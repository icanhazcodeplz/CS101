...
- Parsing Strings to numbers using `Integer.parseInt()` and `Double.parseDouble()`
...
2. Run the following command to download the file:
   ```
   wget https://raw.githubusercontent.com/icanhazcodeplz/CS101/refs/heads/main/labs/lab4_input_and_casting/lab4InputAndCasting.java
   ```

### Complete the Lab
1. Add lines of code below each question, testing your code along the way.
2. When complete, upload the file and submit on Canvas. You must get ALL steps correct to get credit (no partial credit). You may resubmit as many times as needed to get full credit.
