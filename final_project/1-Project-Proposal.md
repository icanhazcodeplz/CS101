# CS101 Project Proposal (10pts) - Due in class 4/7
...
### Requirements
 ...
 - No storing user data to be used later (too complicated)
 - Running the app must not require an internet connection
 - If Andoid App, must only have a single page (screen).
...
#### Interface: [*CLI* or *Android App*] (circle one)
#### **Inputs**: How does the user interact with the app?
<br><br><br><br><br><br><br><br><br>

#### Outputs: What does the user get back based on their inputs?
